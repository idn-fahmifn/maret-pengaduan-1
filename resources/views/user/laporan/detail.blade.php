                            ...
                            <form action="#" method="get">
                                <div class="flex items-center">
                                    <input type="text" name="keyword" id="keyword" value="{{ Request::get('keyword') }}"
                                        ...
                                        class="rounded-l-md py-1 px-4 bg-transparent dark:text-gray-200 w-1/2 focus:outline-none">
                                    <button type="submit"
                                        class="bg-red-500 border border-red-500 hover:bg-red-600 text-white rounded-r-md py-1 px-4">Cari</button>
                                </div>
                            </form>
                        </div>
